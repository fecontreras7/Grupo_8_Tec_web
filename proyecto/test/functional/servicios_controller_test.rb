...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { cliente_id: @servicio.cliente_id, fecha: @servicio.fecha, nombre: @servicio.nombre, precio: @servicio.precio }
    end
  ...
  test "should update servicio" do
    put :update, id: @servicio, servicio: { cliente_id: @servicio.cliente_id, fecha: @servicio.fecha, nombre: @servicio.nombre, precio: @servicio.precio }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
